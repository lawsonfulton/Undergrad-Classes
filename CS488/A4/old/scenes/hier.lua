...
-- glass = gr.transparent_material({0.0, 0.0, 0.0}, {0.1, 0.1, 0.1}, 50, 1.52,0.95)
-- s2 = gr.nh_sphere('s2', {0,2,0}, 2)
-- arc:add_child(s2)
...
l1 = gr.light({200,200,400}, {0.8, 0.8, 0.8}, {2, 0, 0})
l2 = gr.light({0, 5, -20}, {0.4, 0.4, 0.8}, {2, 0, 0})

gr.render(scene, 'hier.png', 800, 800, 
