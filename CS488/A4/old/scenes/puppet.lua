...
blue = gr.material({0.1, 0.2, 0.8}, {0.3, 0.3, 0.3}, 20)
green = gr.material({0.2, 0.8, 0.1}, {0.3, 0.3, 0.3}, 20)
...
white_light = gr.light({5,5,-5}, {1.0, 1.0, 1.0}, {1, 0, 0})


gr.render(rootnode, 'puppet.png', 400, 400,
